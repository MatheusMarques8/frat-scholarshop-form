...
<head>
  ...
  <style>
    ...
    .linkedin-card { align-self: end; display: block; padding: 9px 11px; background: #f8fafc; color: #111827; font-size: 16px; font-weight: 800; line-height: 1.22; text-decoration: none; overflow-wrap: anywhere; word-break: break-word; border-radius: 6px; }
    .linkedin-card span { color: #111827; font-weight: 900; }
  </style>
</head>
<body>
  <article class="post">
